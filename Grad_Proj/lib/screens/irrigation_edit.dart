...
class IrrigationEdit extends StatefulWidget {
  final String farm;
  final String field;
  const IrrigationEdit({super.key, required this.farm, required this.field});

  @override
  State<IrrigationEdit> createState() => _IrrigationEditState();
}

class _IrrigationEditState extends State<IrrigationEdit> {
  bool tell = true;
  ...
  @override
  void initState() {
    context.read<FieldBloc>().add(OpenFieldIrrigationUnitsEvent(
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<FieldBloc, FieldState>(
      listener: (context, state) {
        if (state is ViewFieldIrrigationUnitFailure) {
          ...
          fields = state.fields;
        } else if (state is IrrigationUnitEditFailure) {
          context
              .read<FieldBloc>()
        ...
        } else if (state is IrrigationUnitEditSuccess) {
          context
              .read<FieldBloc>()

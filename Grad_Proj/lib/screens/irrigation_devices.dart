...
class IrrigationDevices extends StatefulWidget {
  ...
  @override
  State<IrrigationDevices> createState() => IrrigationDevicesState();
}

class IrrigationDevicesState extends State<IrrigationDevices> {
  ...
  void reloadData() {
    context.read<FieldBloc>().add(
          OpenFarmIrrigationUnitsEvent(farmId: widget.farmId),
        );
  }

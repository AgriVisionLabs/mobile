...
class _DiseaseDetectionShowImageState extends State<DiseaseDetectionShowImage> {
  ...
  void initState() {
    ...
    _controlBloc!.add(OpenDiseaseDetectionEvent(
        farmId: widget.farmId, scanid: widget.scanId));
    super.initState();
  }
    ...
    return Scaffold(
      ...
      body: BlocBuilder<ControlBloc, ControlState>(
        builder: (context, state) {
          if (state is DiseaseDetectionSuccess) {
            fieldId = state.info.fieldId;
            return Padding(
                      ...
                      Row(children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color:
                                getHealthLevelColor(state.info.healthStatus)!,
          ...
          } else if (state is DiseaseDetectionFailure) {
            return Center(

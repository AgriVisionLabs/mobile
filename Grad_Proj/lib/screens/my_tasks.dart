...
class MyTasks extends StatefulWidget {
  ...
  final String farmId;
  const MyTasks({super.key, required this.farmName, required this.farmId});
    ...
    return BlocBuilder<ControlBloc, ControlState>(
      builder: (context, state) {
        if (state is ViewTasksFailure) {
          ...
          final myTasks =
              state.tasks.where((task) => task.assignedToId == userId).toList();
          return Container(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        DateFormat('MMM dd, yyyy').format(item.assignedAt!),
                                        style: const TextStyle(
                                          fontSize: 17,
                                          color: Colors.black,
